...
window.TOPBRS_APP_VERSION = 'i18n-stage2-onboarding-1';
        ...
        <div class="flip-card-inner">
          ...
          <form class="setup-box glass-inset flip-face flip-front" id="clanForm">
            ...
            <div class="member-access">
              ...
              <button type="button" class="inline-link" id="openLogin" data-i18n="auth.login">Login</button>
              <span data-i18n="auth.or">ou</span>
              <button type="button" class="inline-link" id="openSignup" data-i18n="auth.signup">Cadastre-se</button>
            </div>
          ...
          <div class="setup-box glass-inset flip-face flip-back" id="authBack">
            <button type="button" class="flip-close" id="backToClan" aria-label="${i18nT('common.back')}">×</button>
