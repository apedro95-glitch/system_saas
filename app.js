...
window.TOPBRS_APP_VERSION = 'api-member-fix-1';
...
function bindOnboardingBadgePicker(){
  document.querySelector('#onboardClanBadgePreviewWrap')?.addEventListener('click', openOnboardingBadgePicker);
  document.querySelector('#onboardBadgeEditBtn')?.addEventListener('click', event=>{event.preventDefault(); event.stopPropagation(); openOnboardingBadgePicker();});
}
