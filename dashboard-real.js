...
function canEditClanBadge(){
  ...
  return Boolean(u.saasOwner || u.systemOwner || u.owner || u.isOwner || u.isAdmin || role.includes("owner") || role.includes("admin") || role.includes("lider") || role.includes("líder"));
}
document.querySelectorAll(".dash-badge-edit").forEach(btn=>{
  ...
  btn.addEventListener("click", (event)=>{
    ...
    window.dispatchEvent(new CustomEvent("topbrs:open-clan-badge-picker"));
  });
});
