...
await syncClanAndMembersFromApi().catch(error=>console.warn('Sync inicial dashboard indisponível:', error));
...
const tag=document.querySelector('[data-dashboard-clan-tag], .dash-clan span span');
