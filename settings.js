...
function i18nS(key, values = {}){
  ...
  const fallback = {
    'pt-BR': {'settings.thisDevice':'Este dispositivo','settings.active':'ativa','settings.local':'local','settings.device':'Dispositivo','settings.ended':'encerrada','settings.endSession':'Encerrar'},
    'en-US': {'settings.thisDevice':'This device','settings.active':'active','settings.local':'local','settings.device':'Device','settings.ended':'ended','settings.endSession':'End'},
    'es-ES': {'settings.thisDevice':'Este dispositivo','settings.active':'activa','settings.local':'local','settings.device':'Dispositivo','settings.ended':'cerrada','settings.endSession':'Cerrar'}
  };
