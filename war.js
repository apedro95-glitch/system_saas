...
document.querySelector('#warRefreshBtn')?.addEventListener('click', async ()=>{
 const btn=document.querySelector('#warRefreshBtn');
 try{
  btn?.classList.add('syncing');
  await loadRealWarMembers();
  renderWarList();
 }catch(error){
  console.warn('Falha ao atualizar guerra:', error);
 }finally{
